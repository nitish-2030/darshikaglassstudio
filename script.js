(function(){
  ...
  var SERVICES = [
    {icon:'i-glass', tag:'01', title:'All Type Glass Work', cat:'glass', img:'assets/services/glass-work.jpg',
      desc:'Toughened partitions, shower cubicles, tabletops and windows — cut and fitted for a precise finish.'},
    {icon:'i-aluminium', tag:'02', title:'Aluminium Work', cat:'aluminium', img:'assets/services/aluminium-work.jpg',
      desc:'Doors, windows and section work built for durability and a smooth, modern look.'},
    {icon:'i-mirror', tag:'03', title:'Digital Mirror', cat:'mirrors', img:'assets/services/digital-mirror.jpg',
      desc:'Printed and LED-lit mirrors that add a modern focal point to any room.'},
    {icon:'i-wallpaper', tag:'04', title:'Wallpaper Installation', cat:'interior', img:'assets/services/wallpaper.jpg',
      desc:'Wall coverings installed smoothly and evenly, from textures to bold patterns.'},
    {icon:'i-interior', tag:'05', title:'Interior Work', cat:'interior', img:'assets/services/interior-work.jpg',
      desc:'Room layouts and finishing work planned around how the space is actually used.'},
    {icon:'i-furniture', tag:'06', title:'Furniture Work', cat:'interior', img:'assets/services/furniture-work.jpg',
      desc:'Custom wardrobes, cabinets and modular furniture built to fit your space.'},
    {icon:'i-ceiling', tag:'07', title:'PVC False Ceiling', cat:'ceiling', img:'assets/services/false-ceiling.jpg',
  ...
  var WORK = [
    ...
    {type:'video', src:'assets/work/clip-2-web.mp4', poster:'assets/work/clip-2-poster.webp', tag:'Aluminium', title:'Glass Cabinet'},
    ...
    {type:'video', src:'assets/work/clip-4-web.mp4', poster:'assets/work/clip-4-poster.webp', tag:'', title:''},
    {type:'video', src:'assets/work/clip-5-web.mp4', poster:'assets/work/clip-5-poster.webp', tag:'LED Mirror', title:'Touch Sensor Mirror'},
  ...
  var PROJECTS = [
    {image:'assets/projects/glass-partition-living-room.jpg', title:'Living Room Partition', category:'Glass', location:'Sidhi'},
    {image:'assets/projects/aluminium-shopfront-frame.jpg', title:'Shopfront Frame', category:'Aluminium', location:'Sidhi'},
    {image:'assets/projects/bedroom-mirror-feature-wall.jpg', title:'Bedroom Feature Wall', category:'Mirrors', location:''},
    {image:'assets/projects/office-cabin-interior.jpg', title:'Office Cabin Layout', category:'Interior', location:'Sidhi'},
    {image:'assets/projects/pvc-false-ceiling-hall.jpg', title:'PVC False Ceiling', category:'Ceiling', location:''},
    {image:'assets/projects/shower-cubicle-glass.jpg', title:'Shower Cubicle', category:'Glass', location:''},
    {image:'assets/projects/modular-wardrobe-interior.jpg', title:'Modular Wardrobe', category:'Interior', location:'Majhauli'},
    {image:'assets/projects/aluminium-balcony-window.jpg', title:'Balcony Window', category:'Aluminium', location:''},
    {image:'assets/projects/salon-digital-mirror.jpg', title:'Salon Digital Mirror', category:'Mirrors', location:'Sidhi'},
    {image:'assets/projects/accent-wallpaper-bedroom.jpg', title:'Accent Wallpaper', category:'Interior', location:''},
    {image:'assets/projects/gypsum-led-cove-ceiling.jpg', title:'Gypsum + LED Cove', category:'Ceiling', location:'Sidhi'},
    {image:'assets/projects/staircase-glass-railing.jpg', title:'Staircase Railing', category:'Glass', location:''}
  ];
  ...
  WORK.forEach(function(w){
    ...
    if(w.type === 'video'){
      item.innerHTML =
        ...
        '<span class="clip-badge"><svg class="icon" aria-hidden="true"><use href="#i-play"/></svg></span>'+
        '<div class="cap"><span class="cap-tag">'+w.tag+'</span><span class="cap-title">'+w.title+'</span></div>';
    } else {
      item.innerHTML =
